...
class Order(models.Model):
    ...
    def __str__(self):
        return f"Заказ № {self.pk} | Покупатель {self.Order.name}"

class OrderItem(models.Model):
    order = models.ForeignKey(to=Order, on_delete=models.CASCADE, verbose_name="Заказ")
    product = models.ForeignKey(Products, on_delete=models.SET_DEFAULT, null=True, verbose_name="Проудкт", default=None)
